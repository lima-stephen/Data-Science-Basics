...
#cart_data<- data.frame(cart_data$Card_Cust_ID,cart_data$Gender,cart_data$Education_level,cart_data$Last_Month_spend,
                     #cart_data$Last_3m_avg_spend,cart_data$Spend_Drop_over50pct)

cart_data<-subset(cart_data,select=-X)
